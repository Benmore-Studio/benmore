...
// serveBootCheck is the framework-edition no-op for the platform's
// serve-time validator pass (app_check.go). The validator stack lives
// behind the platform tag; local framework/cloud serve skips it.
