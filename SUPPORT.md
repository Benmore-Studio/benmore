...
- **`./benmore docs`** - the embedded guide catalog; use `docs build` for the app guide and `docs harness` for agent/edition guidance.
...
- **App `AGENTS.md`** - the shared Codex/Claude contract; framework contributor instructions are separate.
